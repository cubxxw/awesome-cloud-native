<template><div><h1 id="design-proposal-simplified-port-configuration-via-config-files-for-kubernetes-deployment" tabindex="-1"><a class="header-anchor" href="#design-proposal-simplified-port-configuration-via-config-files-for-kubernetes-deployment" aria-hidden="true">#</a> Design Proposal: Simplified Port Configuration via Config Files for Kubernetes Deployment</h1>
