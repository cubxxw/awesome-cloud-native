...
<p>[toc]</p>
<h3 id="自定义镜像mycentosjava8" tabindex="-1"><a class="header-anchor" href="#自定义镜像mycentosjava8" aria-hidden="true">#</a> 自定义镜像mycentosjava8</h3>
<h5 id="要求" tabindex="-1"><a class="header-anchor" href="#要求" aria-hidden="true">#</a> 要求：</h5>
...
<p><img src="https://s2.loli.net/2022/05/13/LRMtS6w2PDBTxfQ.jpg" alt="graphic"></p>
...
<h5 id="拉取镜像" tabindex="-1"><a class="header-anchor" href="#拉取镜像" aria-hidden="true">#</a> 拉取镜像</h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="验证环境" tabindex="-1"><a class="header-anchor" href="#验证环境" aria-hidden="true">#</a> 验证环境</h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="构建一些增强型功能–编写dockerfile文件" tabindex="-1"><a class="header-anchor" href="#构建一些增强型功能–编写dockerfile文件" aria-hidden="true">#</a> 构建一些增强型功能–编写dockerfile文件</h5>
...
<h5 id="构建编写的dockerfile-生成新的镜像" tabindex="-1"><a class="header-anchor" href="#构建编写的dockerfile-生成新的镜像" aria-hidden="true">#</a> 构建编写的dockerfile，生成新的镜像</h5>
...
<h5 id="运行" tabindex="-1"><a class="header-anchor" href="#运行" aria-hidden="true">#</a> 运行</h5>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>docker run -it 新镜像名字:TAG
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="最后" tabindex="-1"><a class="header-anchor" href="#最后" aria-hidden="true">#</a> 最后</h3>
<h5 id="再体会下unionfs-联合文件系统" tabindex="-1"><a class="header-anchor" href="#再体会下unionfs-联合文件系统" aria-hidden="true">#</a> 再体会下UnionFS（联合文件系统）</h5>
