...
<nav class="table-of-contents"><ul><li><router-link to="#docker-的总架构图">Docker 的总架构图</router-link><ul><li><router-link to="#图解">图解</router-link></li></ul></li><li><router-link to="#docker-各模块组件分析">Docker 各模块组件分析</router-link><ul><li><router-link to="#docker-client【发起请求】">Docker Client【发起请求】</router-link></li><li><router-link to="#docker-daemon【后台守护进程】">Docker Daemon【后台守护进程】</router-link></li><li><router-link to="#docker-server【调度分发请求】">Docker Server【调度分发请求】</router-link></li><li><router-link to="#engine">Engine</router-link></li></ul></li><li><router-link to="#docker-registry【镜像注册中心】">Docker Registry【镜像注册中心】</router-link></li><li><router-link to="#graph【docker-内部数据库】">Graph【docker 内部数据库】</router-link><ul><li><router-link to="#repository">Repository</router-link></li><li><router-link to="#graphdb">GraphDB</router-link></li><li><router-link to="#driver【执行部分】">Driver【执行部分】</router-link></li></ul></li><li><router-link to="#libcontainer【函数库】">libcontainer【函数库】</router-link></li><li><router-link to="#docker-container【服务交付的最终形式】">docker container【服务交付的最终形式】</router-link></li></ul></nav>
<p>[toc]</p>
<h2 id="docker-的总架构图" tabindex="-1"><a class="header-anchor" href="#docker-的总架构图" aria-hidden="true">#</a> Docker 的总架构图</h2>
<img src="@source/markdown/images/AWZcyjfvLDJmEnq.jpg" alt="img" style="zoom: 33%;" />
...
<p><img src="@source/markdown/images/JFbxhyeoDKrEcYv.jpg" alt="连接暂时失效"></p>
</li>
</ul>
<h3 id="docker-server【调度分发请求】" tabindex="-1"><a class="header-anchor" href="#docker-server【调度分发请求】" aria-hidden="true">#</a> Docker Server【调度分发请求】</h3>
<ul>
<li>Docker Server 的架构图</li>
</ul>
<p><img src="@source/markdown/images/wmt5A9KnYLIuaCs.jpg" alt="连接暂时失效"></p>
<ol>
...
<h3 id="engine" tabindex="-1"><a class="header-anchor" href="#engine" aria-hidden="true">#</a> Engine</h3>
<ol>
...
<h2 id="docker-registry【镜像注册中心】" tabindex="-1"><a class="header-anchor" href="#docker-registry【镜像注册中心】" aria-hidden="true">#</a> Docker Registry【镜像注册中心】</h2>
<ol>
...
<h2 id="graph【docker-内部数据库】" tabindex="-1"><a class="header-anchor" href="#graph【docker-内部数据库】" aria-hidden="true">#</a> Graph【docker 内部数据库】</h2>
<p>Graph 的架构图</p>
<img src="@source/markdown/images/RgSq5sTlQA3v6ck.jpg" alt="img" style="zoom: 100%;" />
...
<h3 id="graphdb" tabindex="-1"><a class="header-anchor" href="#graphdb" aria-hidden="true">#</a> GraphDB</h3>
<ol>
...
<h4 id="第一个-graphdriver" tabindex="-1"><a class="header-anchor" href="#第一个-graphdriver" aria-hidden="true">#</a> 第一个：graphdriver</h4>
<ul>
<li>
<p>graphdriver 架构图</p>
<img src="@source/markdown/images/AHdQ2EIVw3xtWYU.jpg" alt="img"  />
</li>
</ul>
<ol>
...
<h4 id="第二个-networkdriver" tabindex="-1"><a class="header-anchor" href="#第二个-networkdriver" aria-hidden="true">#</a> 第二个：networkdriver</h4>
<ul>
<li>
<p>networkdriver 的架构图</p>
<img src="@source/markdown/images/8znfrJvIRK4OYAp.jpg" alt="img" style="zoom:100%;" />
</li>
</ul>
<ol>
...
<h4 id="第三个-execdriver" tabindex="-1"><a class="header-anchor" href="#第三个-execdriver" aria-hidden="true">#</a> 第三个：execdriver</h4>
<ul>
<li>
<p>execdriver 的架构图</p>
<img src="@source/markdown/images/zxtojRYDAZ21k6P.jpg" alt="img" style="zoom:100%;" />
</li>
</ul>
<ol>
<li>
<p>execdriver 作为 Docker 容器的执行驱动，负责创建容器运行命名空间，负责容器资源使用的统计与限制，负责容器内部进程的真正运行等。</p>
</li>
<li>
<p>现在 execdriver 默认使用 native 驱动，不依赖于 LXC。</p>
</li>
</ol>
<h2 id="libcontainer【函数库】" tabindex="-1"><a class="header-anchor" href="#libcontainer【函数库】" aria-hidden="true">#</a> libcontainer【函数库】</h2>
<ul>
<li>
...
<h2 id="docker-container【服务交付的最终形式】" tabindex="-1"><a class="header-anchor" href="#docker-container【服务交付的最终形式】" aria-hidden="true">#</a> docker container【服务交付的最终形式】</h2>
<ul>
<li>
<p>container 架构</p>
<img src="@source/markdown/images/IA1V6OFJQTNGyPj.jpg" alt="img" style="zoom:50%;" />
</li>
</ul>
<ol>
