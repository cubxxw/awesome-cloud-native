<template><div><h1 id="docker高级篇" tabindex="-1"><a class="header-anchor" href="#docker高级篇" aria-hidden="true">#</a> Docker高级篇</h1>
<p>[toc]</p>
<h3 id="mysql主从复制docker版" tabindex="-1"><a class="header-anchor" href="#mysql主从复制docker版" aria-hidden="true">#</a> mysql主从复制docker版</h3>
<h5 id="_1-新建主服务器容器实例" tabindex="-1"><a class="header-anchor" href="#_1-新建主服务器容器实例" aria-hidden="true">#</a> 1. 新建主服务器容器实例</h5>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>docker run -p 3307:3306 --name mysql-master \
...
default-character-set<span class="token operator">=</span>utf8mb4
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-修改后重启实例" tabindex="-1"><a class="header-anchor" href="#_3-修改后重启实例" aria-hidden="true">#</a> 3.修改后重启实例</h5>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>docker restart mysql-master
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_4-创建数据同步用户" tabindex="-1"><a class="header-anchor" href="#_4-创建数据同步用户" aria-hidden="true">#</a> 4. 创建数据同步用户</h5>
...
<h5 id="_5-新建从服务器3308" tabindex="-1"><a class="header-anchor" href="#_5-新建从服务器3308" aria-hidden="true">#</a> 5. 新建从服务器3308</h5>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>docker run -p 3308:3306 --name mysql-slavea \
