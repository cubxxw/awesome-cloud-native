...
<h3 id="检查集群状态获取8号机器noid" tabindex="-1"><a class="header-anchor" href="#检查集群状态获取8号机器noid" aria-hidden="true">#</a> 检查集群状态获取8号机器noid</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="删除8号机器" tabindex="-1"><a class="header-anchor" href="#删除8号机器" aria-hidden="true">#</a> 删除8号机器</h3>
<ul>
<li>
...
<h3 id="清空槽号并且分配" tabindex="-1"><a class="header-anchor" href="#清空槽号并且分配" aria-hidden="true">#</a> 清空槽号并且分配</h3>
...
<p><img src="https://s2.loli.net/2022/05/12/tPyVcjvnbfq5gmz.png" alt="image-20220512212110632"></p>
<p><strong>可以看到1号结点占有的槽位两倍，7号没有槽位</strong></p>
<h3 id="删除7号" tabindex="-1"><a class="header-anchor" href="#删除7号" aria-hidden="true">#</a> 删除7号</h3>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>redis-cli --cluster del-node ip:端口 id
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://s2.loli.net/2022/05/12/7hiMYy4PnVQE1wB.png" alt="image-20220512212310546"></p>
