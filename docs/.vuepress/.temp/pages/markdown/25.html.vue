...
<p>[toc]</p>
<p><strong>参考tomcat8的dockerfile入门https://github.com/docker-library/tomcat/blob/master/10.0/jdk8/corretto/Dockerfile</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="参数讲解" tabindex="-1"><a class="header-anchor" href="#参数讲解" aria-hidden="true">#</a> 参数讲解</h3>
<ul>
<li>
<p>from：基础镜像，一般来自哪个（继承）</p>
</li>
<li>
<p>maintainer：镜像维护者的姓名和邮箱地址</p>
</li>
<li>
<p>run：容器构建时候执行的命令（docker build)</p>
<ul>
<li>shell格式</li>
<li>exec格式</li>
</ul>
...
<li>
<p>workdir：指定创建容器后，终端默认登陆进来的工作目录</p>
</li>
<li>
<p>user：指定镜像以什么样的用户进行（一般不用）</p>
</li>
<li>
<p>env：用来在构建镜像过程中设置环境变量</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>ENV CATALINA_HOME /usr/local/tomcat
ENV PATH $CATALINA_HOME/bin:$PATH
RUN mkdir -p "$CATALINA_HOME"
WORKDIR $CATALINA_HOME
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>add：将宿主目录下的文件拷贝到镜像且自动处理URL和解压的tar压缩包</p>
</li>
<li>
<p>copy：（类似于add），将构建的文件、目录复制到新的一层镜像内</p>
<p><strong>·     COPY src dest</strong></p>
<p><strong>·     COPY [&quot;src&quot;, &quot;dest&quot;]</strong></p>
<p><strong>·     &lt;src源路径&gt;：源文件或者源目录</strong></p>
<p><strong>·     &lt;dest目标路径&gt;：容器内的指定路径，该路径不用事先建好，路径不存在的话，会自动创建。</strong></p>
</li>
<li>
<p>volume：容器卷，相当于<code v-pre>-v</code></p>
</li>
<li>
<p><strong>cmd：启动容器后需要做的事情</strong></p>
<ul>
<li><strong>类似于run，也支持shell或者exec</strong></li>
<li><strong>dockerfile中可以用多个cmd指令，但只有最后一个生效，cmd会被docker run之后的参数替换</strong>
<ul>
...
<li>
<p>entrypoint：也是用来指定一个容器启动时要运行的命令</p>
<ul>
...
<p><img src="https://s2.loli.net/2022/05/13/2W6k1Q4qxgDR9NL.jpg" alt="graphic"></p>
<table>
<thead>
<tr>
<th>是否传参</th>
...
<p><a href="">比如：WORKDIR $MY_PATH</a></p>
<hr>
</div></template>
