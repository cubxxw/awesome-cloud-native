...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="重要部分" tabindex="-1"><a class="header-anchor" href="#重要部分" aria-hidden="true">#</a> 重要部分</h2>
...
<p><img src="https://s2.loli.net/2022/05/09/dsXLwc4beYiZNlv.png" alt="image-20220509205710035"></p>
...
<h3 id="查看容器内运行的进程" tabindex="-1"><a class="header-anchor" href="#查看容器内运行的进程" aria-hidden="true">#</a> 查看容器内运行的进程</h3>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>docker top 容器ID
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://s2.loli.net/2022/05/09/Xe76W8HZut2SsVo.png" alt="image-20220509210625854"></p>
<h3 id="查看容器内部细节" tabindex="-1"><a class="header-anchor" href="#查看容器内部细节" aria-hidden="true">#</a> 查看容器内部细节</h3>
<blockquote>
...
<h3 id="进入正在运行的容器并且以命令行交互" tabindex="-1"><a class="header-anchor" href="#进入正在运行的容器并且以命令行交互" aria-hidden="true">#</a> 进入正在运行的容器并且以命令行交互</h3>
...
<p><strong>==推荐使用exec==</strong></p>
<h3 id="用redis案例实操" tabindex="-1"><a class="header-anchor" href="#用redis案例实操" aria-hidden="true">#</a> 用redis案例实操</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://s2.loli.net/2022/05/09/hzrfSYwLy3E5lJq.png" alt="image-20220509213628075"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="导入" tabindex="-1"><a class="header-anchor" href="#导入" aria-hidden="true">#</a> 导入</h4>
