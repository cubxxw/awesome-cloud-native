...
<p>:::</p>
<h3 id="apiserver" tabindex="-1"><a class="header-anchor" href="#apiserver" aria-hidden="true">#</a> APIServer</h3>
...
<h3 id="kubernetes-资源" tabindex="-1"><a class="header-anchor" href="#kubernetes-资源" aria-hidden="true">#</a> Kubernetes 资源</h3>
...
<h3 id="controller-控制器" tabindex="-1"><a class="header-anchor" href="#controller-控制器" aria-hidden="true">#</a> Controller 控制器</h3>
...
<h3 id="schedule-调度器" tabindex="-1"><a class="header-anchor" href="#schedule-调度器" aria-hidden="true">#</a> Schedule 调度器</h3>
<p>调度器是一种特殊的控制器，负责监视 Pod 变化并将 Pod 分派给节点，调度器可以被直接替换掉或者是使用多个调度器，除此之外官方默认的调度器也支持 WebHook。</p>
<h3 id="cni-网络插件" tabindex="-1"><a class="header-anchor" href="#cni-网络插件" aria-hidden="true">#</a> CNI 网络插件</h3>
...
<h3 id="csi-存储插件" tabindex="-1"><a class="header-anchor" href="#csi-存储插件" aria-hidden="true">#</a> CSI 存储插件</h3>
<p>CSI 存储插件，全称 Container Storage Interface，可以通过 CSI 接口支持不同的存储类型</p>
<h3 id="cri-容器运行时" tabindex="-1"><a class="header-anchor" href="#cri-容器运行时" aria-hidden="true">#</a> CRI 容器运行时</h3>
...
<p>从 <code v-pre>Operator</code> 理念的提出到现在已经有了很多工具可以帮助我们快速低成本的开发，其中最常用的就是 CoreOS 开源的 <code v-pre>operator-sdk</code> 和 <code v-pre>k8s sig</code> 小组维护的 <code v-pre>kubebuilder</code>，我们这个系列选用 kubebuilder。</p>
