...
**Borg** is a [cluster manager](https://en.wikipedia.org/wiki/Cluster_manager) used by [Google](https://en.wikipedia.org/wiki/Google).[[docs/Cloud-Native-k8s/1]](https://en.wikipedia.org/wiki/Borg_(cluster_manager)#cite_note-1)[[2\]](https://en.wikipedia.org/wiki/Borg_(cluster_manager)#cite_note-2) It led to widespread use of similar approaches such as [Docker](https://en.wikipedia.org/wiki/Docker_(software)) and [Kubernetes](https://en.wikipedia.org/wiki/Kubernetes).[[3\]](https://en.wikipedia.org/wiki/Borg_(cluster_manager)#cite_note-3)
